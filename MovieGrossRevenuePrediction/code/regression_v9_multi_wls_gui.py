	...
	for index,row in datacollected.iterrows():
 	...
 	for index,row in datacollected_l.iterrows():
		...
		df_l.index = df_l.index + 1  # shifting index
 		df_l = df_l.sort() 
	df.to_csv('/home/geekdon/Desktop/MovieData/output_rotten/csv_data_00_14/'+str(genre)+'_all_high.csv',index = False)
	df_l.to_csv('/home/geekdon/Desktop/MovieData/output_rotten/csv_data_00_14/'+str(genre)+'_all_low.csv',index = False)
...
def main():
	...
	for genre in genre_:
		...
		PATH1 = '/home/geekdon/Desktop/MovieData/output_rotten/csv_data_00_14/'+str(genre)+'_all_low.csv'
		if not os.path.isfile(PATH) and not os.path.isfile(PATH1):
